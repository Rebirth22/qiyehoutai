...
import type { AttrResponeData, CategoryResponseData } from "./type";
enum API {
    // 一级分类接口地址
...
// 对应分类下的商品基础属性和属性值
export const reqAttr = (category1Id: number | string, category2Id: number | string, category3Id: number | string) => request.get<any, AttrResponeData>(API.ATTR_URL + `${category1Id}/${category2Id}/${category3Id}`)
//新增或者修改属性
